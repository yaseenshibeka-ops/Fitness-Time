  ...
  <div>
    ...
    <div v-else-if="subscriptions.length" class="glass-card p-0 overflow-hidden">
      <table class="table table-dark table-hover mb-0">
        <thead><tr><th>User</th><th>Plan</th><th>Price</th><th>Status</th><th>Start</th><th>End</th><th></th></tr></thead>
        <tbody>
          <tr v-for="s in subscriptions" :key="s.subscription_id">
            ...
            <td><button class="btn btn-sm btn-outline-danger" @click="cancelSub(s.subscription_id)">Cancel</button></td>
          </tr>
        </tbody>
      </table>
