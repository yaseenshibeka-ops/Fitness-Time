...
-- ===== ORDERS =====
INSERT INTO orders (order_id, user_id, order_reference, full_name, email, phone, delivery_address, subtotal, delivery_fee, grand_total, status) VALUES
...
-- ===== PAYMENTS =====
INSERT INTO payments (payment_id, user_id, order_id, subscription_id, payment_method, phone_number, amount, transaction_reference, payment_status, payment_date) VALUES
...
-- ===== FITNESS PROGRESS =====
INSERT INTO fitness_progress (progress_id, user_id, weight_kg, height_cm, body_fat_pct, chest_cm, waist_cm, hips_cm, biceps_cm, workout_type, duration_minutes, calories_burned, notes, recorded_date) VALUES
...
-- ===== FITNESS GOALS =====
INSERT INTO fitness_goals (goal_id, user_id, goal_type, target_value, current_value, unit, deadline, status) VALUES
...
-- ===== WORKOUT HISTORY =====
INSERT INTO workout_history (workout_id, user_id, workout_type, duration_minutes, calories_burned, notes, workout_date) VALUES
